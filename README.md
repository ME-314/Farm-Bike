...
![Render of the machine](https://github.com/ME-314/Farm-Bike/blob/main/Resources/FrameAssyRender.jpg)
...
## Specification 
#### Functionality 
- Provide a way of converting human power into usefull shaft work
...
- Resist storade in wet condtions
#### Durability
- Be built where ever possible out of standard parts to ensure longterm parts availabilty
- Machined component to only use conventional machining to provide possibilty of field repair
